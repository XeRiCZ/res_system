...
namespace Chata_IS.Account
{
    public partial class AddNews : System.Web.UI.Page
    {
        ...
        protected void SaveNews(object sender, EventArgs e)
        {
            ...
            parameters.Add(new MySqlParameter("@html_text", CKEditor1.Text));
            parameters.Add(new MySqlParameter("@datum", nDate));

            if (SQLBase.Instance.Insert("insert into Novinka (`html_text`, `datum`)" +
                " values (@html_text,@datum);", parameters))
            {
